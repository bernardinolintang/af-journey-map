      ...
      if (!celebrated.has(key) && currentPct >= m && prevPct < m) {
        ...
        if (m === 100) {
          ...
          const msgs: Record<number, { title: string; desc: string }> = {
            25: {
              title: "🎉 Quarter done!",
              desc: `${visitedCount} of ${currentTotal} outlets — you're on a roll!`,
            },
            50: {
              title: "🔥 Halfway there!",
              desc: `${visitedCount} of ${currentTotal} outlets crushed. Keep going!`,
            },
            75: {
              title: "⚡ 75% complete!",
              desc: `${visitedCount} of ${currentTotal} outlets. The finish line is close!`,
            },
          };
